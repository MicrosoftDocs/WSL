...
1. Download these two .txt files and rename them .cmd
    ...
    - [start_lxcore_trace.txt](https://github.com/Microsoft/BashOnWindows/files/288621/start_lxcore_trace.txt)
    - [stop_lxcore_trace.txt](https://github.com/Microsoft/BashOnWindows/files/288622/stop_lxcore_trace.txt)
...
6. Post the files with your GitHub post to our [issue page](https://github.com/Microsoft/BashOnWindows/issues).
...
Look for the **OS Build** and **System Type** fields.  
    ![About system information](media/system.png)

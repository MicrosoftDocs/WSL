...
<mark style="background-color: lightblue">AllowLocalFirewallRules:False means the locally defined firewall rules, like that by HNS, will not be applied or used.</mark>
...
<mark style="background-color: lightblue">AllowInboundRules: False means that no inbound Firewall rules will be applied.</mark>

...
Please see the [Configure per distro launch settings with wslconf](./manage.md#configure-per-distro-launch-settings-with-wslconf) article for instructions on how to do this.
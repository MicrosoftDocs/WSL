...
description: Compare version 1 and version 2 of the Windows Subsystem for Linux. WSL 2 increases file system performance and supports full system call compatibility.

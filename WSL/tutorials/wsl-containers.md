...
- [Install WSL and set up a user name and password for your Linux distribution running in WSL 2](../install-command.md).
...
To install Docker (after already [installing WSL](../install-command.md)):
